...
if not openai.api_key:
    raise ValueError("Please set the OPENAI_API_KEY environment variable or provide AIPROXY_TOKEN in Google Colab.")
...
def interact_with_llm(filename, df, max_tokens=1500):
    ...
    try:
        ...
        executed_results["analysis_results"] = exec_globals
        print("\n\n########################################\n###########################")
        print(executed_results)
        print(f"Analysis executed successfully.")
    except Exception as e:
        print(f"Error in executing Analysis : {e}")
...
def main():
    ...
    try:
        ...
        print(f"Error generating visualizations--1: {e}")
        sys.exit(1)
